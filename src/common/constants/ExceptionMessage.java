...
public class ExceptionMessage {
    ...
    public static final String SAME_BEAN_EXCEPTION_MESSAGE_FORMAT = "Instance types %s already exists in context";
    ...
    public static final String TARGET_OBJECT_NPE_MESSAGE = "the object to be overridden must not be null";
